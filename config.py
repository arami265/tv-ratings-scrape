...
# Short wait when making HTTP requests, this is to avoid being refused
SHORT_WAIT = 1

# Long wait after being refused a connection
LONG_WAIT = 45

# Days to wait until updating a show again
DAYS_TO_WAIT = 7

# Datetime format, the default ISO 8601 format is currently preferred
